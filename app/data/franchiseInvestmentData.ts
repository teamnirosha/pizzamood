...
export const franchiseInvestmentConfig: FranchiseInvestmentConfig = {
  ...
  mainHeadingLine1: "Start With ₹4 Lakh.",
...
export const investmentItemsData: InvestmentItemData[] = [
  {
    id: "item-1",
    name: "Brand & Franchise Rights Fee",
    amount: 150000,
    formattedAmount: "₹ 1,50,000",
    notes: "Trademark usage, operational manual, onboarding rights & store launch clearance",
    iconName: "Handshake",
  },
  {
    id: "item-2",
  ...
  {
    id: "item-4",
    name: "Initial Raw Material & Packaging",
    amount: 35000,
    formattedAmount: "₹ 35,000",
    notes: "Signature dough mix, pizza sauce, 100% mozzarella cheese & packaging",
    iconName: "PartyPopper",
  },
  {
    id: "item-5",
    name: "Local Launch Marketing & POS",
    amount: 25000,
    formattedAmount: "₹ 25,000",
    notes: "Digital marketing campaign, flyers, POS software setup & uniforms",
    iconName: "Handshake",
  },
];
